...
const Checkout = () => {
    ...
    return (
        <Fragment>
            <div className='flex items-center justify-between px-20 sm:px-5 border-b border-[#DEDEDE] sm:w-full'>
                <Link to={"/"} className='p-3 sm:p-2'>
                    <img src="https://yt3.googleusercontent.com/HnAnUZS7d8LFtPHaHRtPH9nMoUmrsBBy_FDD-T-YQIycPW55peuWo1NO_rxPIswDbukXYlk7=s176-c-k-c0x00ffffff-no-rj"
                        className='h-[50px] sm:h-[35px] sm:w-[35px]  rounded-full mr-8' alt="" />
                </Link>
                <h3 className='text-2xl font-medium text-black sm:text-base sm:mr-11'>CHECKOUT</h3>
                <div className='flex text-sm sm:block'>
                    <p className='text-[#646464] font-normal sm:text-xs'>Having troubles? Call us: </p>
                    <p className='font-medium text-black sm:text-xs'>+44 (0) 2076604453</p>
                </div>
            </div>
            <FormContainer>
                <div className='flex justify-between mt-9 sm:flex-col'>
                    <div className='w-9/12 sm:w-full sm:px-2 sm:py-4 px-5 py-8 mr-3 border border-[#DEDEDE] rounded-md'>
                        <p className='mb-5 text-lg font-medium text-black sm:text-base sm:mb-3'>Payment method</p>
                        <div className='flex mb-8 select-none sm:mb-3 sm:h-12 sm:justify-center'>
                            <div className='flex  sm:w-[100px]  items-center sm:p-2 sm:mr-4  justify-center border border-[#DEDEDE] p-4 cursor-not-allowed mr-8'>
                                ...
                                <p className='ml-3 sm:text-xs text-[#646464] font-medium text-sm'>Paypal</p>
                            </div>
                            <div className='flex sm:w-[100px] items-center sm:p-2 sm:mr-4 justify-center border border-[#DEDEDE] p-4 cursor-not-allowed mr-8'>
                                ...
                                <p className='ml-3 sm:text-xs text-[#646464] font-medium text-sm'>Credit Card</p>
                            </div>
                            <div className='flex sm:w-[100px] items-center sm:p-2 justify-center border border-[#000] p-4 cursor-pointer'>
                                ...
                                <p className='ml-3 sm:text-xs text-[#000] font-medium text-sm'>Cash On Delivery</p>
                            </div>
                        </div>
                        <p className='mb-5 text-lg font-medium text-black sm:text-base sm:mb-3'>Add Payment Details</p>
                    ...
                    <div className='w-4/12 px-5 border border-[#DEDEDE] rounded-md sm:mt-5 sm:w-full sm:px-3'>
                        <h3 className='text-2xl font-medium mt-7 sm:text-xl sm:mt-3'>Summary</h3>
                        <div className='flex justify-between mt-8 sm:mt-3'>
                            <p className='text-lg font-medium sm:text-base'>Subtotal</p>
                            <p className='text-lg font-normal sm:text-base'>{`$ ${totalAmount.toFixed(2)}`}</p>
                        </div>
                        <div className='flex justify-between mt-5 mb-8 sm:mt-2 sm:mb-3'>
                            <p className='text-lg font-medium sm:text-base'>Delivery</p>
                            <p className='text-lg font-normal sm:text-base'>{`$ 0`}</p>
                        </div>
                        ...
                        <div className='flex justify-between mt-5 sm:mt-3'>
                            ...
                            <p className='text-lg font-semibold text-[#B02B2B] sm:pb-3 pb-8'>{`$ ${totalAmount.toFixed(2)}`}</p>
                        </div>
                    </div>
                </div>
                <div className="flex items-center justify-between mt-6 cursor-pointer sm:mt-3">
                    <div className="px-6 py-4 text-white bg-black rounded-sm sm:px-3 sm:py-2">
                        <Link to={"/cart"} className="font-normal">BACK</Link>
                    </div>
                    {!checkDataCustomers && <div className='font-bold text-red-500 drop-shadow-md'>ERROR</div>}
                    <div onClick={handleConfirmPayment} className="px-6 py-4 text-white bg-black rounded-sm sm:px-3 sm:py-2">
